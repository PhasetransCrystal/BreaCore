...
public class RegistrateDistExecutor {
     ...
     * @param toRun A supplier of the callable to run (Supplier wrapper to ensure classloading only on the appropriate
     *              dist)
    ...
    /**
     * Runs the supplied Runnable on the speicified side. Same warnings apply as
     * {@link #unsafeCallWhenOn(Dist, Supplier)}.
     *
