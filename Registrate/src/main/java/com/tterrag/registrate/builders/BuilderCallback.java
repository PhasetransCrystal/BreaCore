 ...
 * registration for the built entry that lazily creates and registers it.
 */
@FunctionalInterface
public interface BuilderCallback {
     ...
     * @param entryFactory
     *                     A {@link NonNullFunction} which accepts the entry delegate and returns a
     *                     {@link RegistryEntry} wrapper
    ...
    /**
     * Accept a built entry, to later be constructed and registered. Uses the default
     * {@link RegistryEntry#RegistryEntry(AbstractRegistrate, DeferredHolder) RegistryEntry factory}.
     * 
     * @param <R>
     *                The registry type to which the entry will be registered
     * @param <T>
