...
//
/// **
// * A builder for biomes, allows for customization of the {@link Biome.Builder biome properties}, and configuration of
// data associated with biomes (lang).
// *
// * @param <T>
...
//
// /**
// * Create a new {@link BiomeBuilder} and configure data. Used in lieu of adding side-effects to constructor, so that
...
// */
// public static <T extends Biome, P> BiomeBuilder<T, P> create(AbstractRegistrate<?> owner, P parent, String name,
// BuilderCallback callback, NonNullFunction<Biome.Builder, T> factory) {
...
//
// protected BiomeBuilder(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback,
// NonNullFunction<Biome.Builder, T> factory) {
// super(owner, parent, name, callback, Biome.class);
// this.factory = factory;
// }
//
// /**
// * Modify the properties of the biome. Modifications are done lazily, but the passed function is composed with the
...
//
// /**
// * Replace the initial state of the biome properties, without replacing or removing any modifications done via {@link
// #properties(NonNullUnaryOperator)}.
// *
// * @param properties
...
//
// /**
// * Set the weight for this biome to generate in the overworld in regions matching the given type. This can only be
...
//
// /**
// * Manually add what would have been the "best guess" types from the {@link BiomeDictionary} for this biome. This has
// no effect if no types are added via
...
// * @return this {@link BiomeBuilder}
// */
// public BiomeBuilder<T, P> addFeature(Decoration stage, NonNullSupplier<Feature<NoFeatureConfig>> feature,
// NonNullSupplier<Placement<NoPlacementConfig>> placement) {
...
// * @return this {@link BiomeBuilder}
// */
// public <FC extends IFeatureConfig> BiomeBuilder<T, P> addFeature(Decoration stage, NonNullSupplier<Feature<FC>>
// feature, FC featureConfig, NonNullSupplier<Placement<NoPlacementConfig>> placement) {
...
// * @return this {@link BiomeBuilder}
// */
// public <PC extends IPlacementConfig> BiomeBuilder<T, P> addFeature(Decoration stage,
// NonNullSupplier<Feature<NoFeatureConfig>> feature, NonNullSupplier<Placement<PC>> placement, PC placementConfig) {
...
// * @return this {@link BiomeBuilder}
// */
// public <FC extends IFeatureConfig, PC extends IPlacementConfig> BiomeBuilder<T, P> addFeature(Decoration stage,
// NonNullSupplier<Feature<FC>> feature, FC featureConfig, NonNullSupplier<Placement<PC>> placement, PC placementConfig)
// {
// return addConfiguredFeature(stage, () ->
// feature.get().withConfiguration(featureConfig).withPlacement(placement.get().configure(placementConfig)));
// }
//
// /**
...
//
// /**
// * Add a callback that will be invoked after all {@link Feature Features} are registered, for the purpose of adding
// them to this biome.
// * <p>
// * Any {@link Feature} object can be safely referenced here and added to the biome via {@link
...
// * @return this {@link BiomeBuilder}
// */
// public <CC extends ICarverConfig> BiomeBuilder<T, P> addCarver(Carving type, NonNullSupplier<WorldCarver<CC>> carver,
// CC carverConfig) {
...
//
// /**
// * Add a callback that will be invoked after all {@link WorldCarver WorldCarvers} are registered, for the purpose of
// adding them to this biome.
// * <p>
// * Any {@link WorldCarver} object can be safely referenced here and added to the biome via {@link
// Biome#addCarver(Carving, ConfiguredCarver)}
// *
// * @param action
...
// * @return this {@link BiomeBuilder}
// */
// public BiomeBuilder<T, P> addSpawn(EntityClassification type, NonNullSupplier<? extends EntityType<?>> entity, int
// weight, int minGroupSize, int maxGroupSize) {
...
//
// /**
// * Add a callback that will be invoked after all {@link EntityType Entities} are registered, for the purpose of adding
// entity spawns to this biome.
// * <p>
// * Any {@link EntityType} object can be safely referenced here and added to the biome via {@link
